...
export default function ReviewsPage() {
  ...
  const columns: ColumnDef<Review>[] = [
    ...
    { accessorKey: 'comment', header: 'Comment', cell: ({ row }) => <span className="line-clamp-2 max-w-xs">{row.original.comment || '—'}</span> },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Badge variant="secondary">{data?.meta?.total || 0} pending</Badge>
      </div>
